...
export PATH=$PATH:~/.local/bin # needed for fd

###############################
### REMOVE THESE FOR YOURSELF
###############################

[ -f "/home/mredzic/.ghcup/env" ] && . "/home/mredzic/.ghcup/env" # ghcup-env

# Update these paths when dev-nix flakes are moved
# inside of dotfiles projet (or wherever they end up)
flake-cpp() {
    (cd ~/Documents/dev-nix-flakes && make cpp)
}
